...
namespace Student.DAL
{
	...
	public partial class NEEDYSTUDENT_INFO
	{
		...
		public bool Exists(decimal RCD_ID)
		{
			...
			strSql.Append("select count(1) from NEEDYSTUDENT_INFO");
		...
		/// 增加一条数据
		/// </summary>
		public decimal Add(Student.Model.NEEDYSTUDENT_INFO model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into NEEDYSTUDENT_INFO(");
			strSql.Append("STUNO,TERMNO,RANKING,TYPE,MEMO)");
			...
			parameters[1].Value = model.TERMNO;
			parameters[2].Value = model.RANKING;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Student.Model.NEEDYSTUDENT_INFO model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update NEEDYSTUDENT_INFO set ");
			...
			parameters[3].Value = model.TYPE;
			parameters[4].Value = model.MEMO;
			parameters[5].Value = model.RCD_ID;
		...
		public bool Delete(decimal RCD_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from NEEDYSTUDENT_INFO ");
			strSql.Append(" where RCD_ID=@RCD_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@RCD_ID", SqlDbType.Decimal)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Student.Model.NEEDYSTUDENT_INFO GetModel(decimal RCD_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 RCD_ID,STUNO,TERMNO,RANKING,TYPE,MEMO from NEEDYSTUDENT_INFO ");
			strSql.Append(" where RCD_ID=@RCD_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@RCD_ID", SqlDbType.Decimal)
			};
			...
			Student.Model.NEEDYSTUDENT_INFO model=new Student.Model.NEEDYSTUDENT_INFO();
		...
		/// 得到一个对象实体
		/// </summary>
		public Student.Model.NEEDYSTUDENT_INFO DataRowToModel(DataRow row)
		{
			Student.Model.NEEDYSTUDENT_INFO model=new Student.Model.NEEDYSTUDENT_INFO();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select RCD_ID,STUNO,TERMNO,RANKING,TYPE,MEMO ");
			strSql.Append(" FROM NEEDYSTUDENT_INFO ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" RCD_ID,STUNO,TERMNO,RANKING,TYPE,MEMO ");
			strSql.Append(" FROM NEEDYSTUDENT_INFO ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from NEEDYSTUDENT_INFO T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "NEEDYSTUDENT_INFO";
