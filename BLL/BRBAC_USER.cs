...
namespace Student.BLL
{
	...
	{
		private readonly Student.DAL.BRBAC_USER dal=new Student.DAL.BRBAC_USER();
		public BRBAC_USER()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Student.Model.BRBAC_USER GetModelByCache(decimal USER_ID)
		{
			
			string CacheKey = "BRBAC_USERModel-" + USER_ID;
			...
			return (Student.Model.BRBAC_USER)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Student.Model.BRBAC_USER> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Student.Model.BRBAC_USER> DataTableToList(DataTable dt)
		{
			List<Student.Model.BRBAC_USER> modelList = new List<Student.Model.BRBAC_USER>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Student.Model.BRBAC_USER model;
