...
namespace Student.BLL
{
	...
	{
		private readonly Student.DAL.MAJOR_INFO dal=new Student.DAL.MAJOR_INFO();
		public MAJOR_INFO()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Student.Model.MAJOR_INFO GetModelByCache(int MAJORNO)
		{
			
			string CacheKey = "MAJOR_INFOModel-" + MAJORNO;
			...
			return (Student.Model.MAJOR_INFO)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Student.Model.MAJOR_INFO> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Student.Model.MAJOR_INFO> DataTableToList(DataTable dt)
		{
			List<Student.Model.MAJOR_INFO> modelList = new List<Student.Model.MAJOR_INFO>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Student.Model.MAJOR_INFO model;
